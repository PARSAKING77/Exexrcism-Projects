...
def get_rounds(number):
    ...
    """
    return [number, number + 1, number + 2]  # Use 'number' instead of 'round_number'
...
def list_contains_round(rounds, number):
    ...
    """
    return number in rounds  # Use 'number' instead of 'round_number'
...
def average_even_is_average_odd(hand):
    ...
    even_count = (len(hand) + 1) // 2  # Count of even indexed cards
    odd_count = len(hand) // 2  # Count of odd indexed cards
