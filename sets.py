...
def categorize_dish(dish_name, dish_ingredients):
    ...
    ingredients_lower = {ingredient.lower() for ingredient in dish_ingredients}

    if ingredients_lower.issubset(VEGAN):
        return f'{dish_name}: VEGAN'
    
    if ingredients_lower.issubset(VEGETARIAN):
        return f'{dish_name}: VEGETARIAN'
    
    if ingredients_lower.issubset(PALEO):
        return f'{dish_name}: PALEO'
    
    if ingredients_lower.issubset(KETO):
...
def tag_special_ingredients(dish):
    ...
    special_ingredients = ingredient_set.intersection(SPECIAL_INGREDIENTS)
...
def compile_ingredients(dishes):
    ...
    for dish in dishes:
        master_ingredients.update(dish)
...
def separate_appetizers(dishes, appetizers):
    ...
    non_appetizers = [dish for dish in unique_dishes if dish not in unique_appetizers]
